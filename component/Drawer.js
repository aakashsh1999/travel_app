        ...
        return (
            <View style={style.container}>
                    ...
                    <Icon type='Feather' name='x' style={style.icon}/>
                      <Text style={{fontSize:20, fontWeight:'bold', marginLeft:20, color:"#fff"}}>Menu</Text>
                    </View>
                    ...
                    <Text style={{fontSize:14, color:'#fff', fontWeight:'400', marginBottom:15}}>CopyRight &copy; 2020 Askepro</Text>
